...
class Move {
    ...
    private Move(int col0, int row0, int col1, int row1) {
        ...
        if (abs(_toIndex - _fromIndex) == 1
                | abs(_toIndex - _fromIndex) == 10
                | abs(_toIndex - _fromIndex) == 11
                | abs(_toIndex - _fromIndex) == 12) {
            _isExtend = true;
            _isJump = false;
        } else {
            _isJump = true;
    ...
    public String toString() {
        if (_col0 == 0) {
            ...
            String col0 = Character.toString(_col0);
            String row0 = Character.toString(_row0);
            String col1 = Character.toString(_col1);
            String row1 = Character.toString(_row1);
            String output = col0 + row0 + "-" + col1 + row1;
            return output;
        }
    }
